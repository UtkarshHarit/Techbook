<?php
    ...
    $q = "SELECT * FROM students WHERE username='$username' AND password='$password'";
        $query = mysql_query($q);
...
<aside class="profile-card">
    ...
    <header>
        ...
        <?php
            ...
            echo '<form action="proedit.php" method="post" enctype="multipart/form-data">
            <div class="image-upload">
            <label for="file-input">
            <img src="image/'.$img.'"style="width:90%;height:50%;" title="Change Profile Picture"/>
            </label>
            <input type="file" id="file-input" name="img"  onchange="javascript:this.form.submit();"/>
            </div>
            </form>';
    ...
    <a href="forum/forum.php"><button align="center" style="background-color: #4CAF50; /* Green */
    border: none;
    color: white;
    padding: 15px 32px;
    text-align: center;
    ...
    font-size: 16px;"   >FORUM</button></a><br /><br />
     ...
     <a href="logout.php"><button align="center" style="background-color: gray; /* Green */
    border: none;
    color: white;
    padding: 15px 32px;
    text-align: center;
